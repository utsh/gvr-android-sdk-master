...
public class SimpleVrVideoActivity extends Activity {
  ...
  private Uri fileUri= Uri.parse("http://104.198.83.123:1935/vim/_definst_/mp4:https/vimersia/vim/video.mp4/playlist.m3u8");
  ...
  private void handleIntent(Intent intent) {
    ...
    if (Intent.ACTION_VIEW.equals(intent.getAction())) {
      ...
      fileUri = Uri.parse("rtsp://104.198.83.123:1935/vim/sample.mp4");
      if (fileUri == null) {
    ...
    protected Boolean doInBackground(Pair<Uri, Options>... fileInformation) {
      try {
         if (fileInformation == null || fileInformation.length < 1
          ...
          videoWidgetView.loadVideo(Uri.parse("http://104.198.83.123:1935/vim/_definst_/mp4:https/vimersia/vim/video.mp4/playlist.m3u8"), options);
        } else {
